...
// INITIAL ATTEMPTS:
// BRUTE FORCE:O(N^2) nested loops. if we are going to do better than O(N^2), probably gonna be O(n lgn) or O(N). O(n lgn) comes up in SORTING/SEARCHING ALGO where we are recursively cutting the array in half. not useful here.
